...
const FAQ_PAGE = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Citadel includes 100+ built-in content apps including Canva, Google Slides, YouTube, Instagram, Live Weather, Google Reviews, X/Twitter, and many more — all at no extra charge.",
      },
    },
    {
      "@type": "Question",
